...
{
    /// <inheritdoc />
    public partial class raidsseederx : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "ExpansionId",
                table: "RaidLocations",
                newName: "RaidExpansionId1");

            migrationBuilder.RenameIndex(
                name: "IX_RaidLocations_ExpansionId",
                table: "RaidLocations",
                newName: "IX_RaidLocations_RaidExpansionId1");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, null, "The Burning Crusade" },
                    { 3, null, "Wrath of the Lich King" },
                    { 4, null, "Cataclysm" },
                    { 5, null, "Mists of Pandaria" },
                    { 6, null, "Warlords of Draenor" },
                    { 7, null, "Legion" },
                    { 8, null, "Battle for Azeroth" },
                    { 9, null, "Shadowlands" },
                    { 10, null, "Dragonflight" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "RaidLocations",
                newName: "IX_RaidLocations_ExpansionId");
